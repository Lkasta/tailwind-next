      ...
      <div className="mt-6 flex flex-col">
        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            <label
              htmlFor="firstName"
              className="text-sm dark:text-zinc-300 dark:text-zinc-400"
            >
              Name
            </label>
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              <Input.InputRoot>
                <Input.InputControl id="firstName" defaultValue="Luiz" />
              </Input.InputRoot>

              <div className="flex flex-col gap-3 lg:block">
                <label
                  htmlFor="lastName"
                  className="text-sm dark:text-zinc-300 dark:text-zinc-400 lg:sr-only"
                >
                  Last Name
                </label>

                <Input.InputRoot>
                  <Input.InputControl id="lastName" defaultValue="Karpinski" />
                </Input.InputRoot>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.InputRoot>
              ...
              <Input.InputControl
                id="email"
                type="email"
                defaultValue="lkasta@lkasta.com.br"
              />
            </Input.InputRoot>
          </div>
